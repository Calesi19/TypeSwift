...
function ShortcutTable() {
  const shortcuts = [
    ...
    },
    {
      id: "acmred",
      shortcut: "acmred",
      phrase: "Verified that ACM light is red on the TMC."
    },
    {
      id: "shoulderl",
      shortcut: "shoulderl",
      ...
      <Table hoverable>
        ...
        <Table.Body className="divide-y">
          ...
          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
            ...
            <Table.Cell >
              <div className="line-clamp-2" style={{ lineClamp: 2 }}>
              lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco  laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. ACM light is green.
              </div>
              </Table.Cell>
          </Table.Row>
        </Table.Body>
